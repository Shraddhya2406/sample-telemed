...
<div class="max-w-2xl mx-auto">
    <!-- Quiz Container -->
    <div id="quiz-container" class="bg-white p-8 rounded shadow" data-dashboard-url="{{ route('dashboard.patient') }}" data-api-base="{{ url('') }}" data-store-url="{{ url('/patient/medicines') }}">
